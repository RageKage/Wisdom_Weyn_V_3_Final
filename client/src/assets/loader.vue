<template>
    <div 
    class="flex flex-col items-center justify-center h-96 md:h-96 lg:h-screen py-4 px-4 my-9"
  >
  ...
  .book-shelf {
    .book-shelf__book {
      animation: book-bounce 0.8s ease infinite;
    ...
    .book-shelf__shelf {
      animation: shelf-lift 0.8s ease infinite;
      animation-iteration-count: infinite;
